...
import './ChartSpectrometer.scss'
import Chart from 'chart.js/auto';
import { getSpectraDataset } from './../../../variables/spectra';

function ChartSpectrometer({ type, fillRef, chartPosRef, drawRef, bodyRef }) {
    ...
    }, [chartPosRef, drawRef, state, ref, fillRef, type, bodyRef])

    return (
        <div className='chart-spectrometer'>
            <canvas ref={ref} />
        </div>
    )
}

export default ChartSpectrometer
